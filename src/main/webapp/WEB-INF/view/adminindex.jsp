                ...
                onClick: function(node){
                    ...
                    if (node.id == "courselist") {
                        ...
                        if(typeof(initcourse) !="function"){
                            ...
                            $.getScript("js/course.js",function(){
...
<div data-options="region:'south',split:true" style="height:60px; text-align:center;">专业：计算机科学与技术&nbsp;&nbsp;班级：计技172班&nbsp;&nbsp;学号：2017107225&nbsp;&nbsp;姓名：韦冠平</div>
